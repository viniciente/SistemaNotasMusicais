...
begin
  ...
  try
    ...
    begin
      ShowMessage('Formato inválido! O arquivo deve conter exatamente 5 campos separados por "|".');
      Exit;
    end;
    ...
    try
      ...
      vQuery.Open;
      if vQuery.IsEmpty then begin ShowMessage('Tipo "' + sTipo + '" não encontrado!'); Exit; end;
      ...
      vQuery.Open;
      if vQuery.IsEmpty then begin ShowMessage('Tonalidade "' + sTonalidade + '" não encontrada!'); Exit; end;
      ...
      begin
        ...
        vQuery.Open;
        if vQuery.IsEmpty then begin ShowMessage('Nota "' + notaNome + '" não encontrada!'); Exit; end;
